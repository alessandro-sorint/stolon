...
func init() {
	...
	CmdKeeper.PersistentFlags().BoolVar(&cfg.skipLockFile, "skip-lock-file", false, "prevent keeper to skip lock file. Warning! It'll cause data corruptions if two keepers are concurrently running with the same data dir.")
